...
const Game: React.FC = () => {
  ...
  return (
    <>
      {/* legacy styles that are still used by the game page */}
      ...
      <header className="game-header retracted">
        ...
        <div className="game-controls">
          ...
          {/* language selector is kept disabled for now */}
          {/*
          <div className="language-selector" style={{ display: 'none' }}>
            <select id="language-selector" onChange={e => changeLanguage(e.target.value)}>
              <option value="fr" defaultSelected>Français</option>
